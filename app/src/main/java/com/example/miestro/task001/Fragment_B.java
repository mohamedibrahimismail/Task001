...
public class Fragment_B extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        myfragment =  inflater.inflate(R.layout.fragment_b,container,false);
        String category_id=getArguments().getString("category_id");
        Json_Url ="http://souq.hardtask.co/app/app.asmx/GetCategories?categoryId="+category_id+"&countryId=1";
